...
export default function Footer() {
  ...
  const socialLinks = [
    {
      name: "GitHub",
      href: "https://github.com/SlyfingNeed",
      icon: (
    ...
    {
      name: "LinkedIn",
      href: "https://www.linkedin.com/in/seva-jaya-satriya/",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <span className="text-2xl font-bold text-white">Get to Know Seva</span>
